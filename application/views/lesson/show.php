...
<?php if ($id[0] == 1) { ?>
	...
	<?php if ($results) { ?>
		...
		<input type="hidden" id="results5" value="<?php print_r($results[0]->lesson5) ?>">
	<?php } else{ ?>
		...
		<input type="hidden" id="results5" value="null">
	<?php } ?>
		<div id="body">
...
<?php }else{ ?>
	<div id="container" ng-controller="lession5" class="container" ng-cloak>
	<input type="hidden" id="user_id" value="<?php print_r($user_id[0]) ?>">
	<?php if ($results) { ?>
		<input type="hidden" id="id_result" value="<?php print_r($results[0]->id) ?>">
		<input type="hidden" id="results1" value="<?php print_r($results[0]->lesson1) ?>">
		...
		<div id="body">
			<span ng-if="type == 1">
				<div class="row" style="padding-top: 75px;">
					...
					<br>
					<div class="row">
						<a href="#" class="btn btn-info btn-lg btn-block" role="button" ng-click="send(randomQuote.spanish,randomQuote,VarSend)">Send</a>
						<a href="#" class="btn btn-primary btn-lg btn-block" role="button" ng-click="next()">Next</a>
					</div>
				</div>
			</span>
			<span ng-if="type == 2">
				<div class="row" style="padding-top: 75px;">
					...
					<br>
					<div class="row">
						<a href="#" class="btn btn-info btn-lg btn-block" role="button" ng-click="send(randomQuote.english,randomQuote,VarSend)">Send</a>
						<a href="#" class="btn btn-primary btn-lg btn-block" role="button" ng-click="next()">Next</a>
					</div>
				</div>
			</span>
			<span ng-if="type == 3 || type == 5">
				<div class="row" style="padding-top: 75px;">
					<span ng-repeat="lesson in lessons">
						<span ng-if="lesson.id == <?php echo $id[0] ?>">
							<center>
